    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Tambah Setting Baru</h5>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ route('admin.settings.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="key" name="key" value="{{ old('key') }}" placeholder="contoh: site_name" required>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="group" name="group" value="{{ old('group', 'general') }}" list="groups" required>
                        <datalist id="groups">
